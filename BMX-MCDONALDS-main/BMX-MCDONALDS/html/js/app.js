...
document.onkeyup = function (data) {
  if (data.which == 27) {
    $.post('https://BMX-MCDONALDS/exit', JSON.stringify({}));
    return
  }
};
...
function finalizarpedido() {
  ...
  if (!($(combomeal).css("display") == "none")) { 
    var cantidadcombomeal = parseInt(document.getElementById('combomealnumber').value, 10); 
    $.post('https://BMX-MCDONALDS/realizarpedido', JSON.stringify({
      item: "combomeal",
      price: 16,
